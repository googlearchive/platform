...
if (!window.ShadowDOMPolyfill) {
  ...
  //HTMLTemplateElement = ShadowDOMPolyfill.wrappers.HTMLElement;
  ...
  */
  ...
  Object.defineProperties(ShadowDOMPolyfill.wrappers.ShadowRoot.prototype, 
      queryPropDefs);
  // install custom querySelector(All) on wrappers.DocumentFragment
  //Object.defineProperties(wrappers.DocumentFragment.prototype, queryPropDefs);
